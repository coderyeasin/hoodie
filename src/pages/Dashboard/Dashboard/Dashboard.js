    ...
    return (
        ...
        <Row className='justify-content-center align-items-center mx-3'>
                ...
                <div className="mx-5 py-3 d-flex flex-column " style={{textAlign:'justify'}}>
                    ...
                    <Link className="fs-5 text-light text-decoration-none" onClick={()=> logOut(navigate)} to=""> <FaSignOutAlt className=" mx-2 fs-5" /> Logout</Link> <br />
                ...
                <div className="mx-5 py-3 d-flex flex-column " style={{textAlign:'justify'}}>
                    <h3 className="text-center text-xl py-5">{user?.displayName} Panel</h3>
                        ...
                        <Link className=" fs-5 text-light text-decoration-none" to="#"> <FaRegSun className="mx-2 fs-5" /> Manage All users </Link> <br />

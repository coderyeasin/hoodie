        ...
        <div className='py-5' >
            ...
            {!isLoading && <Container>
                <Row xs={1} md={2} >
                    ...
                    {view?.map(cloth => <div className='w-100 g-3 items' key={cloth?._id}  >
                       ...
                       <Card  className='d-flex flex-row w-100 neumophorism items' >
                         ...
                         <Card.Body className="mx-auto ">
                                <Card.Title className='text-light'> <H3>{cloth?.title}</H3> </Card.Title>
                         <Card.Text className='text-light w-100' style={{lineHeight:'30px', textAlign:'justify'}}>
                         ...
                         <Card.Footer className="d-flex justify-content-center align-items-center">
                                ...
                                <Link to={`/details/${cloth?._id}`} className='btn btn-primary' style={{ background: 'linear-gradient(45deg, #17262c, #0a1c24)'}}>
                                        Confirm
                                    </Link>
                         </Card.Footer>
                     </Card>
